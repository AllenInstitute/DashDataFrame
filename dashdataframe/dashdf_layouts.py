...
def make_cluster_layout(plot_columns, link_name):
    ...
    methods = ["KMeans", "Spectral Clustering","Agglomerative Ward","Agglomerative Single Linkage", "Agglomerative Average Linkage"]
    cluster_layout = html.Div([
        ...
        html.Div(
            ...
            children=[
                ...
                style={'width': '18%', 'display': 'inline-block', 'overflowY':'scroll', 'height':800,
            ...
            html.Div([
                ...
                html.A(f'{link_name}',id= 'cluster_link', 
                        href='', 
                        target="_blank"),
                ],
            style={'width': '80%','float':'right', 'display':'inline-block', 'fontFamily':'Arial'}),
